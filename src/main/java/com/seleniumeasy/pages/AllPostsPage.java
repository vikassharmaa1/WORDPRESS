...
public class AllPostsPage {
	...
	public void createANewPost(String title, String description) {
		addNewPost.click();
		SimpleFormDemoPage newPost = PageFactory.initElements(driver, SimpleFormDemoPage.class);
	...
	public void editAPost(String presentTitle, String newTitle, String description) {
		...
		CheckboxDemoPage editPost = PageFactory.initElements(driver, CheckboxDemoPage.class);
	...
	public void deleteAPost(String Title) {
		...
		RadiobuttonsDemoPage deletePost = PageFactory.initElements(driver, RadiobuttonsDemoPage.class);
		deletePost.delete();
	}
