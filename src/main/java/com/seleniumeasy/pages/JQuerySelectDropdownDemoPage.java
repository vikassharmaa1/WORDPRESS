...
public class JQuerySelectDropdownDemoPage {
	WebDriver driver;
	...
	public JQuerySelectDropdownDemoPage(WebDriver driver) {
		this.driver = driver;
		System.out.println(driver.getCurrentUrl());
	}

	public void jQuerySelectDropdown(String idx) {
		driver.switchTo().frame(newPostContentFrame);
		newPostContentBody.clear();
		newPostContentBody.sendKeys(idx);
